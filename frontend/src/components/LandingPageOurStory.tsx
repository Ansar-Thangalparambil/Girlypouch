...
export default function LandingPageOurStory() {
  ...
  return (
    <main className="pt-0 bg-[#faf9f6] text-[#1a1c1a] font-sans antialiased overflow-x-hidden relative min-h-screen">
      {/* Apple-style background blur glow shapes */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-[8%] -left-[10%] w-[45%] h-[35%] bg-[#ffdad3] rounded-full blur-[140px] opacity-15"></div>
        <div className="absolute top-[30%] -right-[10%] w-[50%] h-[40%] bg-[#dee6c4] rounded-full blur-[140px] opacity-10"></div>
        <div className="absolute bottom-[8%] left-[15%] w-[35%] h-[30%] bg-[#ffd9e3] rounded-full blur-[140px] opacity-15"></div>
      </div>

      {/* Hero Section */}
      <section className="relative px-6 md:px-16 py-10 md:py-16 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="flex flex-col gap-5">
            <div className="inline-flex items-center px-3 py-0.5 bg-[#ffdad3]/70 backdrop-blur-sm text-[#802918] rounded-full text-[10px] font-bold w-fit uppercase tracking-widest border border-white/20">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold font-display text-[#1a1c1a] leading-tight tracking-tight">
              Flow with Grace. <br />Care with Intention.
            </h1>
            <p className="text-md md:text-lg text-[#56423e] leading-relaxed max-w-md">
              Ditch the drugstore panic. Get premium, organic supplies tailored to your flow, delivered exactly when you need them.
            </p>
            <p className="text-xs md:text-sm italic font-semibold text-[#9f402d] opacity-90 mt-1">
              "Your rhythm is your power, not a pause."
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mt-3">
              <Link 
                href={user ? "/customize" : "/account"} 
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-[32px] overflow-hidden shadow-lg border border-white/40 bg-white relative group">
              <img 
                className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" 
                alt="High-resolution artistic flat lay of organic cotton pads and liners under warm studio lighting" 
                src="/empathetic_flatlay.png"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/5 to-transparent pointer-events-none"></div>
            </div>
            {/* Glassmorphic Floating Stat Chip */}
            <div className="absolute -bottom-4 -left-4 bg-white/60 backdrop-blur-lg px-5 py-3 rounded-2xl shadow-lg hidden lg:flex items-center gap-3 border border-white/45 hover:-translate-y-1 transition-transform">
              <div className="w-9 h-9 rounded-full bg-[#dee6c4]/80 backdrop-blur-sm flex items-center justify-center text-[#5a6147]">
      ...
      {/* Our Story Section - Expanded Spacing & Asymmetry */}
      <section className="py-16 md:py-24 px-6 md:px-16 bg-[#f4f3f1]/45 relative overflow-hidden border-y border-[#ddc0ba]/20" id="our-story">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-12 gap-8 md:gap-16 items-start">
            {/* Left Narrative Column */}
            <div className="md:col-span-7 flex flex-col gap-5">
              <div className="inline-flex items-center px-3 py-0.5 bg-[#dee6c4]/70 backdrop-blur-sm text-[#424a31] rounded-full text-[10px] font-bold w-fit uppercase tracking-widest border border-white/20">
                Our Story
              </div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight text-[#1a1c1a] leading-tight">
                Rethinking Period Care. <br />Designed for your cycle, built for your life.
              </h2>
              <p className="text-sm text-[#56423e] leading-relaxed font-semibold">
                At GirlyPouch, we believe that period care should never be an afterthought. For too long, the industry has relied on generic solutions, hidden ingredients, and one-size-fits-all packages that do not reflect the reality of a modern woman's cycle. We created GirlyPouch to bring absolute control, transparency, and premium quality to your routine—whether you are managing your personal health or stocking a global enterprise.
              </p>
            </div>
            {/* Right Card Column - Shifted slightly down for visual balance */}
            <div className="md:col-span-5 md:mt-8">
              {/* Glassmorphic Mission Card - Enhanced Padding */}
              <div className="p-8 md:p-10 bg-white/50 backdrop-blur-md rounded-3xl shadow-sm border border-white/30">
                <h3 className="text-lg font-bold text-[#9f402d] mb-3 uppercase tracking-wider text-[11px]">Our Mission</h3>
                <p className="text-xs text-[#56423e] leading-relaxed font-semibold">
                  Our mission is simple: to make premium period care seamless, personalized, and accessible. We combined high-end wellness standards with modern technology to build a platform that listens to your body. From giving you the exact mix of products you need for your unique 28-day cycle, to helping workplaces and retail partners effortlessly provide essential care through our wholesale network, we are elevating the standard of women's health.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Empathetic Statement Cards Grid - Added Breathing Room & Clean Icons */}
      <section className="py-12 md:py-20 px-6 md:px-16 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-white/40 backdrop-blur-sm p-8 rounded-3xl shadow-sm border border-white/20 flex flex-col gap-3 transition-all hover:-translate-y-1.5 duration-300 hover:shadow-md">
            <div className="w-10 h-10 rounded-full bg-[#ffdad3]/70 flex items-center justify-center text-[#802918]">
              <span className="material-symbols-outlined text-lg">spa</span>
            </div>
            <h3 className="text-md font-bold tracking-tight text-[#1a1c1a]">Softness for the Sensitive Days</h3>
            <p className="italic text-xs text-[#56423e] font-semibold leading-relaxed">"Honoring the body’s need for rest."</p>
          </div>
          {/* Card 2 */}
          <div className="bg-white/40 backdrop-blur-sm p-8 rounded-3xl shadow-sm border border-white/20 flex flex-col gap-3 transition-all hover:-translate-y-1.5 duration-300 hover:shadow-md">
            <div className="w-10 h-10 rounded-full bg-[#dee6c4]/80 flex items-center justify-center text-[#5a6147]">
              <span className="material-symbols-outlined text-lg">water_drop</span>
            </div>
            <h3 className="text-md font-bold tracking-tight text-[#1a1c1a]">Organic Purity, No Compromises</h3>
            <p className="italic text-xs text-[#56423e] font-semibold leading-relaxed">"Pure care for your most delicate rhythm."</p>
          </div>
          {/* Card 3 */}
          <div className="bg-white/40 backdrop-blur-sm p-8 rounded-3xl shadow-sm border border-white/20 flex flex-col gap-3 transition-all hover:-translate-y-1.5 duration-300 hover:shadow-md">
            <div className="w-10 h-10 rounded-full bg-[#ffd9e3]/70 flex items-center justify-center text-[#834f60]">
              <span className="material-symbols-outlined text-lg">favorite</span>
            </div>
            <h3 className="text-md font-bold tracking-tight text-[#1a1c1a]">Reliable Support, Always</h3>
            <p className="italic text-xs text-[#56423e] font-semibold leading-relaxed">"Steady support when you need it most."</p>
          </div>
        </div>
      </section>

      {/* Dynamic Base Kits Section */}
      <section className="bg-white py-16 md:py-24 px-6 md:px-16 border-y border-[#ddc0ba]/20" id="shop">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {kits.map((kit) => {
              ...
              return (
                <div 
                  key={kit.id} 
                  className={`bg-white/40 backdrop-blur-md p-7 rounded-3xl flex flex-col justify-between min-h-[380px] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg border ${
                    isSub ? 'border-2 border-[#9f402d]' : 'border-white/30'
                  }`}
                >
                  <div>
                    <div className="flex justify-between items-start mb-5">
                      ...
                      <span className={`px-3 py-1 rounded-full text-[9px] font-bold tracking-widest uppercase ${
                        isSub ? 'bg-[#ffdad3]/70 backdrop-blur-sm text-[#802918] border border-white/20' : 'bg-brand-200 text-brand-800'
                      }`}>
                  ...
                  <div>
                    ...
                    <Link 
                      href={user ? `/customize?kit=${kit.slug}` : "/account"} 
      ...
      <section className="bg-[#f4f3f1]/70 py-16 md:py-24 px-6 md:px-16" id="how-it-works">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Value 1 */}
            <div className="bg-white/40 backdrop-blur-sm p-7 rounded-3xl flex flex-col gap-3 items-start text-left shadow-sm hover:shadow-md transition-shadow border border-white/25">
              <div className="w-11 h-11 bg-[#ffdad3]/70 backdrop-blur-sm rounded-xl flex items-center justify-center mb-1 border border-white/20">
            ...
            {/* Value 2 */}
            <div className="bg-white/40 backdrop-blur-sm p-7 rounded-3xl flex flex-col gap-3 items-start text-left shadow-sm hover:shadow-md transition-shadow border border-white/25">
              <div className="w-11 h-11 bg-[#dee6c4]/70 backdrop-blur-sm rounded-xl flex items-center justify-center mb-1 border border-white/20">
            ...
            {/* Value 3 */}
            <div className="bg-white/40 backdrop-blur-sm p-7 rounded-3xl flex flex-col gap-3 items-start text-left shadow-sm hover:shadow-md transition-shadow border border-white/25">
              <div className="w-11 h-11 bg-[#ffd9e3]/70 backdrop-blur-sm rounded-xl flex items-center justify-center mb-1 border border-white/20">
      ...
      <section className="py-16 md:py-24 px-6 md:px-16 max-w-7xl mx-auto overflow-hidden">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="w-full md:w-1/2 order-2 md:order-1">
            <div className="relative">
              {/* Glassmorphic Pouch Visual Card */}
              <div className="bg-white/55 backdrop-blur-lg border border-white/35 rounded-3xl p-6 shadow-md relative z-10 max-w-sm mx-auto md:mx-0">
                <div className="flex justify-between items-start mb-5">
