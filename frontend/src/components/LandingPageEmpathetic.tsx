...
export default function LandingPageEmpathetic() {
  ...
  return (
    <main className="pt-20 bg-[#faf9f6] text-[#1a1c1a] font-sans antialiased overflow-x-hidden relative min-h-screen">
      {/* Apple-style background blur glow shapes */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-[10%] -left-[10%] w-[45%] h-[40%] bg-[#ffdad3] rounded-full blur-[140px] opacity-15"></div>
        <div className="absolute top-[35%] -right-[10%] w-[50%] h-[45%] bg-[#dee6c4] rounded-full blur-[140px] opacity-10"></div>
        <div className="absolute bottom-[10%] left-[15%] w-[35%] h-[35%] bg-[#ffd9e3] rounded-full blur-[140px] opacity-15"></div>
      </div>

      {/* Hero Section */}
      <section className="relative px-6 md:px-16 py-8 md:py-12 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-10 items-center relative z-10">
          <div className="flex flex-col gap-4">
            <div className="inline-flex items-center px-3 py-0.5 bg-[#ffdad3] text-[#802918] rounded-full text-[10px] font-bold w-fit uppercase tracking-widest">
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-[32px] overflow-hidden shadow-lg border border-[#ddc0ba]/30 bg-white relative group">
              <img 
            ...
            {/* Floating Stat Chip */}
            <div className="absolute -bottom-4 -left-4 bg-white/95 backdrop-blur-md px-5 py-3 rounded-2xl shadow-lg hidden lg:flex items-center gap-3 border border-[#ddc0ba]/40 hover:-translate-y-1 transition-transform">
      ...
      {/* Empathetic Statement Cards Grid */}
      <section className="py-6 md:py-8 px-6 md:px-16 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#ddc0ba]/20 flex flex-col gap-2 transition-transform hover:-translate-y-1 duration-300">
            <h3 className="text-md font-bold tracking-tight text-[#1a1c1a]">Softness for the Sensitive Days</h3>
            <p className="italic text-xs text-[#56423e] font-medium leading-relaxed">"Honoring the body’s need for rest."</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#ddc0ba]/20 flex flex-col gap-2 transition-transform hover:-translate-y-1 duration-300">
            <h3 className="text-md font-bold tracking-tight text-[#1a1c1a]">Organic Purity, No Compromises</h3>
            <p className="italic text-xs text-[#56423e] font-medium leading-relaxed">"Pure care for your most delicate rhythm."</p>
          </div>
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#ddc0ba]/20 flex flex-col gap-2 transition-transform hover:-translate-y-1 duration-300">
            <h3 className="text-md font-bold tracking-tight text-[#1a1c1a]">Reliable Support, Always</h3>
            <p className="italic text-xs text-[#56423e] font-medium leading-relaxed">"Steady support when you need it most."</p>
          </div>
        </div>
      </section>
