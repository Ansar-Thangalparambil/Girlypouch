...
# Load environment variables. Inside Docker, we preserve the Compose environment.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-girlypouch-secret-key-2026')
...
DATABASE_URL = os.getenv('DATABASE_URL', 'postgres://postgres:postgres@127.0.0.1:5432/girlypouch')
